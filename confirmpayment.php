<?php
    ...
    $query= "SELECT * FROM `tripcost` WHERE booking_id='$booking_id'";
        ...
        <div class="row">
           <div class="page-header">
            ...
            <div class="col-md-6">
                  ...
                  <?php  echo isset($row['booking_id']); ?></p>    
                  <p><strong>Total Km: </strong>
                  <?php  echo isset( $row['total_km']); ?></p>    
                  <p><strong>Oil Cost: </strong>
                  <?php  echo isset ($row['oil_cost']); ?></p>    
                  <p><strong>Extra Cost: </strong>
                  <?php  echo isset ($row['extra_cost']); ?>
                </p>    
                  <p><strong>Total Cost: </strong>
                  <?php echo isset( $row['total_cost']); ?></p>
